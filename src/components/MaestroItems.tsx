...
import { Item, Location, DriverRoute, User } from '../types.js';
import { 
  Plus, Edit3, Trash2, Save, X, Layers, MapPin, 
  Users, Key, ShieldAlert, Edit2, CheckCircle, Navigation 
} from 'lucide-react';
...
export default function MaestroItems({ 
  ...
  // Navigation tabs
  const [activeTab, setActiveTab] = useState<'items' | 'procedencias' | 'destinos' | 'choferes' | 'usuarios'>('items');
